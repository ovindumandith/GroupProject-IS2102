...
$moderateStressActivities = $data['moderateStressActivities'] ?? [];
$role = $data['role'] ?? 'user';
?>
...
<?php endif; ?>
    ...
    <!-- Content Section -->
    <div class="content">
        <?php if (!empty($moderateStressActivities)): ?>
            <?php foreach ($moderateStressActivities as $row): 
                        ...
                        <span class="overlay">
                            <?php if ($role === 'admin' || $role === 'superadmin'): ?>
                                ...
                                <form method="POST" class="delete-form">
                                    ...
                                    <input type="hidden" name="redirect_page" value="moderate_level_relaxation_activities.php">
