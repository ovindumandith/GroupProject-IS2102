...
<head>
    ...
    <title>Denied Appointments | RelaxU</title>
            ...
            <tbody>
                <?php foreach ($appointments as $appointment): ?>
                    <tr>
                        ...
                        <td data-label="Status"><span class="status-badge deny-badge"><?= htmlspecialchars($appointment['status']) ?></span></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
...
<?php else: ?>
    <p style="text-align: center;">No denied appointments at the moment.</p>
<?php endif; ?>
        </div>
    </div>
